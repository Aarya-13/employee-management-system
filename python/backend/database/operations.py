...
from backend.database.mock_db import MockDatabase
...
def _use_mock_db():
    ...
    if not USE_MOCK_DB:
        try:
            ...
            USE_MOCK_DB = True
            print("MySQL not available, using in-memory mock database")
    return USE_MOCK_DB
...
def create_employee(employee_data: Dict[str, Any]) -> Optional[Employee]:
    ...
    """
    if _use_mock_db():
        return MockDatabase.create_employee(employee_data)
...
def get_employee(employee_id: int) -> Optional[Employee]:
    ...
    """
    if _use_mock_db():
        return MockDatabase.get_employee(employee_id)
...
def get_all_employees() -> List[Employee]:
    ...
    """
    if _use_mock_db():
        return MockDatabase.get_all_employees()
...
def update_employee(employee_id: int, employee_data: Dict[str, Any]) -> Optional[Employee]:
    ...
    """
    if _use_mock_db():
        return MockDatabase.update_employee(employee_id, employee_data)
...
def delete_employee(employee_id: int) -> bool:
    ...
    """
    if _use_mock_db():
        return MockDatabase.delete_employee(employee_id)
